...
def upgrade() -> None:
    ...
    sa.Column('default_price', sa.Numeric(precision=18, scale=2), nullable=True, comment='默认单价'),
    ...
    sa.Column('default_contract_template_id', sa.Integer(), nullable=True, comment='默认合同模板'),
    ...
    op.bulk_insert(
        service_types_table,
        [
            {"id": 1, "code": "evaluation", "name": "安全评价", "is_active": True, "created_at": "2026-01-01 00:00:00+00", "updated_at": "2026-01-01 00:00:00+00"},
            {"id": 2, "code": "training", "name": "安全培训", "is_active": True, "created_at": "2026-01-01 00:00:00+00", "updated_at": "2026-01-01 00:00:00+00"},
            {"id": 3, "code": "inspection", "name": "安全检测检验", "is_active": True, "created_at": "2026-01-01 00:00:00+00", "updated_at": "2026-01-01 00:00:00+00"},
            {"id": 4, "code": "consulting", "name": "安全咨询顾问", "is_active": True, "created_at": "2026-01-01 00:00:00+00", "updated_at": "2026-01-01 00:00:00+00"},
            {"id": 5, "code": "emergency_plan", "name": "应急预案编制", "is_active": True, "created_at": "2026-01-01 00:00:00+00", "updated_at": "2026-01-01 00:00:00+00"},
        ]
    )
    # 重置序列
